...
namespace mvc.Models
{
    public class LateFee
    {
        ...
        {
            string query = "SELECT * FROM late_fee WHERE id = 1";
        ...
        public void Update(float late_fee, int id)
        {
            string query = "UPDATE late_fee SET late_fee='" + late_fee + "' WHERE id='" + id + "'";

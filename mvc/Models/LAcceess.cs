...
namespace mvc.Models
{
    public class LAcceess
    {
        ...
        //Update statement
        public void Update(float Monday, float Tuesday, float Wednesday, float Thursday, float Friday, float Saturday, int id)
        {
            string query = "UPDATE limit_acceess_fee SET monday = '" + Monday.ToString() + "', Tuesday = '" + Tuesday.ToString() + "', Wednesday = '" + Wednesday.ToString() + "', Thursday = '" + Thursday.ToString() + "', Friday = '" + Friday.ToString() + "', Saturday = '" + Saturday.ToString() + "' WHERE id='" + id + "'";
        ...
        {
            string query = "SELECT * FROM limit_acceess_fee WHERE id = 1";
